...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.add_column('questions_question', 'answer_date',
    ...
    def backwards(self, orm):
        ...
        db.delete_column('questions_question', 'answer_date')
    ...
    models = {
        ...
        'questions.question': {
            ...
            'answer_date': ('django.db.models.fields.DateTimeField', [], {'null': 'True'}),
            ...
            'subject': ('django.db.models.fields.CharField', [], {'default': "''", 'max_length': '50'})
        },
