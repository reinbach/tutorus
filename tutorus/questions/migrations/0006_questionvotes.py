...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'QuestionVotes'
        db.create_table('questions_questionvotes', (
        ...
        db.send_create_signal('questions', ['QuestionVotes'])

        # Deleting field 'Question.vote_count'
        db.delete_column('questions_question', 'vote_count')


    def backwards(self, orm):
        # Deleting model 'QuestionVotes'
        db.delete_table('questions_questionvotes')

        # Adding field 'Question.vote_count'
        db.add_column('questions_question', 'vote_count',
    ...
    models = {
        ...
        'questions.questionvotes': {
            'Meta': {'object_name': 'QuestionVotes'},
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
