...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'Step'
        db.create_table('step_step', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('name', self.gf('django.db.models.fields.CharField')(max_length=50, blank=True)),
            ('step_order', self.gf('django.db.models.fields.PositiveSmallIntegerField')()),
        ...
        db.send_create_signal('step', ['Step'])


    def backwards(self, orm):
        # Deleting model 'Step'
        db.delete_table('step_step')
    ...
    models = {
        ...
        'step.step': {
            ...
            'step_order': ('django.db.models.fields.PositiveSmallIntegerField', [], {})
        }
    }
