...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Scratchpad.classroom'
        db.alter_column('scratchpad_scratchpad', 'classroom_id', self.gf('django.db.models.fields.related.OneToOneField')(default=0, to=orm['classroom.ClassRoom'], unique=True))

    def backwards(self, orm):

        # Changing field 'Scratchpad.classroom'
        db.alter_column('scratchpad_scratchpad', 'classroom_id', self.gf('django.db.models.fields.related.OneToOneField')(to=orm['classroom.ClassRoom'], unique=True, null=True))
